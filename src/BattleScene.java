public class BattleScene {
    public void fight(Characters hero, Characters monster, Realm.FightCallback fightCallback) {
        Runnable runnable = () -> {
            int turn = 1;
    ...
    private Boolean makeHit(Characters defender, Characters attacker, Realm.FightCallback fightCallback) {
